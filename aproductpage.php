...
<div class="row">
	...
	<div class="card-body">
    <h5 class="card-title" > <a style="color:black" href="http://localhost/marvel/viewprod2.php?productid=$<?php echo $row['prod_id']; ?>" class="card-link "><?php  echo $row['prod_name'] ?></a> </h5>
